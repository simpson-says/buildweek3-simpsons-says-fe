...
class Favorites extends Component {
  ...
  displayQuotes = () => {
    ...
    return axios
      .get(`https://simpson-says.herokuapp.com/api/favorites`, headers)
      .then(res => {
        this.setState({
          quoteList: res.data
        });
    ...
    return (
      <div style={container}>
        {localStorage.getItem("token") ? null : (
          <div className="genQuote">Please Login to see favorites</div>
        )}
          ...
          return (
            <div key={currentQuote.id} className="quoteBox">
              ...
              <div
                ...
                onClick={() => this.props.saveFavorites(currentQuote.quote_id)}
              >
                {clickedStar}
              </div>
            </div>
